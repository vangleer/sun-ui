<template>
  <component :is="tag">
    <div class="sun-overlay" :class="[overlayClass]" :style="overlayStye" @click="handleOverlayClick"></div>
    <div class="sun-popup" :style="styleObj" :class="['sun-popup-'+position,round?'sun-popup-round':'']"
      @click="handlePopupClick">
      <img class="sun-popup-cross-img" :class="['sun-popup-icon-close-'+closeIconPosition]" v-if="isUrl&&closeable"
