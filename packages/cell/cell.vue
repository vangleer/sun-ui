<template>
  <div
    class="sun-cell"
    :class="{ 'sun-cell-border': border,'sun-cell-effect':calBgEffect }"
  ...
  >
    ...
    <div
      v-if="(value||isLink)&&!$slots.default"
      :style="{textAlign:title?'right':'left'}"
      class="sun-cell-value"
      :class="[valueClass]"
    >
      <span>{{ value }}</span>
    ...
    <div
      v-else
      :style="{textAlign:value?'right':'left'}"
      class="sun-cell-value"
      :class="[valueClass]"
    >
      <slot></slot>
